...
import com.none.staff.HttpsHelper.FakeX509TrustManager;
...
public class MyPushMessageReceiver extends PushMessageReceiver {
	...
	private void createHttpRequestUsedToVolley() {
		...
		RequestQueue queue = Volley.newRequestQueue(StaffApplication.getApp());

		FakeX509TrustManager.allowAllSSL();
		String serverUrl=contex.getResources().getString(R.string.server_url);
	...
	public void onNotificationClicked(Context context, String title,
		...
		try {
			FileUtils.writeTextFile(saveFile, customContentString);
		} catch (IOException e) {
			e.printStackTrace();
		}
		EventBus.getDefault().post(new MyPushEvent(customContentString));
	...
	public void onNotificationArrived(Context context, String title,
		...
		String notifyString = "onNotificationArrived  title=\"" + title
				...
				+ customContentString;
		Log.d("111", "customContentString"+customContentString);
	}
	...
	private void updateContent(Context context, String content) {
		...
		intent.setClass(context.getApplicationContext(), staff.class);
