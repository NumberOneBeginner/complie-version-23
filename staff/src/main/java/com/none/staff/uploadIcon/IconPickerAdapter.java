...
public class IconPickerAdapter extends BaseAdapter {
	...
	public IconPickerAdapter(Context context, boolean showCamera, int itemSize){
		mContext = context;
	...
	public View getView(int i, View view, ViewGroup viewGroup) {
		...
		if(type == TYPE_CAMERA){
			view = mInflater.inflate(R.layout.item_select_icon, viewGroup, false);
			view.setTag(null);
...
//			holde.indicator = (ImageView) view.findViewById(R.id.checkmark_icon);
...
//			indicator = (ImageView) view.findViewById(R.id.checkmark_icon);
//			mask = view.findViewById(R.id.mask_icon);
			view.setTag(this);
		}
