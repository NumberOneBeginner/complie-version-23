/*
 * ==============================================================================
 * = Copyright (c) 2012-2014 Qualcomm Connected Experiences, Inc. All Rights
 * Reserved.
 * 
 * Vuforia is a trademark of QUALCOMM Incorporated, registered in the United
 * States and other countries. Trademarks of QUALCOMM Incorporated are used
 * with permission.
 * ============================================================
 * ===================
 */
...
public class SampleApplicationSession implements UpdateCallbackInterface {
	...
	//LICENSE_KEY BELONG Tracy
	// private static final String LICENSE_KEY = "";

	//LICENSE_KEY BELONG Bob
	private static final String LICENSE_KEY ="";
	...
	public void initAR(Activity activity, int screenOrientation) {
		...
		m_activity.getWindow().setFlags(WindowManager.LayoutParams.FLAG_KEEP_SCREEN_ON,
	...
	public void stopAR() throws SampleApplicationException {
		...
		synchronized (mShutdownLock) {
			...
			if (!unloadTrackersResult)
				throw new SampleApplicationException(SampleApplicationException.UNLOADING_TRACKERS_FAILURE,
						"Failed to unload trackers\' data");

			if (!deinitTrackersResult)
				throw new SampleApplicationException(SampleApplicationException.TRACKERS_DEINITIALIZATION_FAILURE,
	...
	private class InitVuforiaTask extends AsyncTask<Void, Integer, Boolean> {
		...
		protected Boolean doInBackground(Void... params)
		{
			...
			synchronized (mShutdownLock)
			{
				Vuforia.setInitParameters(m_activity, mVuforiaFlags,LICENSE_KEY);
		...
		protected void onPostExecute(Boolean result) {
			...
			if (result) {
				...
				if (initTrackersResult) {
					...
					vuforiaException = new SampleApplicationException(SampleApplicationException.TRACKERS_INITIALIZATION_FAILURE,
	...
	private boolean setFocusMode(int mode) throws SampleApplicationException {
		...
		if (!result)
			throw new SampleApplicationException(SampleApplicationException.SET_FOCUS_MODE_FAILURE, "Failed to set focus mode: "
					+ mode);
	...
	private void configureVideoBackground() {
		...
		config.setSize(new Vec2I(xSize, ySize));//这个是video背后图片的大小

		Log.i(LOGTAG, "Configure Video Background : Video (" + vm.getWidth() + " , " + vm.getHeight() + "), Screen ("
				+ mScreenWidth + " , " + mScreenHeight + "), mSize (" + xSize + " , " + ySize + ")");
